...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location -Path 'C:\xampp\htdocs\whats-app'; npm run dev" -WindowStyle Normal
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location -Path 'C:\xampp\htdocs\whats-app'; cloudflared tunnel --no-autoupdate run myapp" -WindowStyle Normal
